...
class BookedParkingOwner extends StatefulWidget {
  const BookedParkingOwner({Key? key}) : super(key: key);

  @override
  State<BookedParkingOwner> createState() => _BookedParkingOwnerState();
}

class _BookedParkingOwnerState extends State<BookedParkingOwner> {
  @override
      ...
      body: Padding(
        ...
        child: Column(
          children: [
            ...
            customAppBarWithBack(context, "Booked Parking"),
            Container(
              // color: Colors.amber,
